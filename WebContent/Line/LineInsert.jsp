    ...
    <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="14"></td>
            <td class="text_cray"><input type="text" name="trafficCode" id="textfield2" /></td>
          </tr>
        </table>
      ...
      <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="14"></td>
            <td colspan="3" align="left"><input name="stationName" type="text" class="text_cray" id="textfield2" /></td>
          </tr>
          ...
          <tr>
            ...
            <td></td>
            <td width="175" align="left" class="text_cray"><input type="text" name="departureTime" id="textfield7" /></td>
          ...
          <tr>
            ...
            <td></td>
            <td width="175" align="left" class="text_cray"><input type="text" name="arrivalTime" id="textfield7" /></td>
            <td colspan="2" align="left"></td>
          </tr>
          <tr>
            <td align="center" class="text_red">*</td>
          ...
          <tr>
            ...
            <td></td>
            <td width="175" align="left" class="text_cray"><input type="text" name="residenceTime" id="textfield7" /></td>
            <td colspan="2" align="left"></td>
          </tr>
          <tr>
            <td align="center" class="text_red">*</td>
            ...
            <td></td>
            <td width="175" align="left" class="text_cray"><input type="text" name="spendTime" id="textfield7" /></td>
            <td colspan="2" align="left"></td>
          </tr>
          <tr>
            <td align="center" class="text_red">*</td>
            ...
            <td></td>
            <td width="175" align="left" class="text_cray"><input type="text" name="stationCode" id="textfield7" /></td>
            <td colspan="2" align="left"></td>
          </tr>
