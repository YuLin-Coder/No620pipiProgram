    ...
    <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="14"></td>
            <td colspan="3" align="left"><input name="carriageNumber" type="text" class="text_cray" id="textfield2" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="14"></td>
            <td colspan="3" align="left"><input name="carSeatNumber" type="text" class="text_cray" id="textfield2" /></td>
          </tr>
