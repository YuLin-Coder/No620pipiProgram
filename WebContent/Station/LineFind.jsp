...
<script language="javascript">
	function lineInsert(){
		document.location.href="${pageContext.request.contextPath}/Admin/LineInsert.jsp";
	}
	function lineUpdate(){
		document.location.href="${pageContext.request.contextPath}/Admin/LineUpdate.jsp";
	}
</script>
