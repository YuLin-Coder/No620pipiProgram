...
<table width="100%" border="0" cellspacing="0">
  <tr>
    ...
    <td width="140" valign="top" bgcolor="#deedf8" class="text_cray1">欢迎您，${sessionScope.user.ulname }</td>
    <td width="64" align="left" valign="top" bgcolor="#deedf8"><a href="../Login.jsp" target="_blank" class="cray">退出</a></td>
  </tr>
</table>
